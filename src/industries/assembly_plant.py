...
industry = IndustrySecondary(id='assembly_plant',
                             accept_cargos_with_input_ratios=[('VPTS', 2), ('VBOD', 2), ('VENG', 2), ('TYRE', 2)],
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_rear_assembly_hall_windows'),
            ...
            (0, 2, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_central_assembly_hall'),
            (0, 3, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_front_assembly_hall_doors'),
            ...
            (1, 2, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_central_assembly_hall'),
            (1, 3, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_front_assembly_hall_windows'),
            ...
            (2, 2, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_central_assembly_hall'),
            (2, 3, 'assembly_plant_tile_1', 'assembly_plant_spritelayout_front_assembly_hall_doors'),
