...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_empty'),
            ...
            (4, 1, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_large_shed_rear_part'),
            ...
            (5, 1, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_large_shed_front_part'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_small_tanks'),
            ...
            (1, 1, 'blast_furnace_tile_1', 'blast_furnace_spritelayout_large_shed_front_part'),
            ...
            (2, 1, 'blast_furnace_tile_2', 'blast_furnace_spritelayout_large_shed_rear_part'),
