...
industry = IndustrySecondary(id='cement_plant',
                             ...
                             location_checks=dict(industry_min_distance=[('chemical_plant', 500), ('brick_works', 500), ('sawmill', 500), ('supply_yard', 500), ('clay_pit', 50), ('stockyard', 2)], industry_max_distance=['stockyard', 10], same_type_distance=500),
