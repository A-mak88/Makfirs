...
industry = IndustrySecondary(id='electric_arc_furnace',
                             accept_cargos_with_input_ratios=[('SCMT', 4), ('FECR', 2), ('QLME', 1), ('O2__', 1)],
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_2'),
            ...
            (1, 5, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_scrap_1'),
            (2, 0, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_metal_2'),
            (2, 1, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_metal_2'),
            (2, 2, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_metal_1'),
            (2, 3, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_empty'),
            (2, 4, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_crane_1'),
            (2, 5, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_scrap_1'),
            (3, 0, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_metal_2'),
            (3, 1, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_metal_2'),
            (3, 2, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_crane_2'),
            (3, 3, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_empty'),
            (3, 4, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_scrap_2'),
            (3, 5, 'electric_arc_furnace_tile_1', 'electric_arc_furnace_spritelayout_crane_1'),
            ]
)
