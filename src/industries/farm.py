...
industry = IndustryPrimaryOrganic(id='farm',
                                  prod_cargo_types_with_multipliers=[('SGBT', 2), ('FICR', 4)],
                                  prob_in_game='3',
                                  prob_map_gen='5', # intended to be relatively prevalent in Steeltown, split this per economy if needed
                                  map_colour='85',
...
industry.add_tile(id='farm_tile_1',
...
industry.add_industry_layout(
    ...
    layout=[(0, 2, 'farm_tile_1', 'farm_spritelayout_8'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'farm_tile_1', 'farm_spritelayout_4'),
...
industry.add_industry_layout(
    ...
    layout=[(0, 0, 'farm_tile_1', 'farm_spritelayout_8'),
