...
industry = IndustrySecondary(id='flour_mill',
                             accept_cargos_with_input_ratios=[('GRAI', 8), ('MNSP', 2), ('ELEC', 1), ('PASS', 1)],
                             prod_cargo_types_with_output_ratios=[('FOOD', 8), ('PASS', 1), ('PEAT', 1)],
                             prob_map_gen='1',
                             prob_in_game='1',
                             map_colour='49',
                             location_checks=dict(flour_mill_layouts_by_date=True, industry_max_distance=['stockyard', 50]),
