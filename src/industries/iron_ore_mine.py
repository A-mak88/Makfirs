...
industry = IndustryPrimaryExtractive(id='iron_ore_mine',
                                     prod_cargo_types_with_multipliers=[('IORE', 8), ('RCYC', 2)],
                                     map_colour='55',
                                     prob_in_game='3',
                                     prob_map_gen='4',
                                     prospect_chance='0.75',
                                     name='TTD_STR_INDUSTRY_NAME_IRON_ORE_MINE',
                                     location_checks=dict(industry_min_distance=['coal_mine', 1], industry_max_distance=['coal_mine', 10], cluster=[500, 3], same_type_distance=1),
