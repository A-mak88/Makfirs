...
industry = IndustrySecondary(id='lumber_yard',
                             ...
                             prod_cargo_types_with_output_ratios=[('GOOD', 8), ('BDMT', 2), ('PEAT', 2)],
                             prob_in_game='3',
                             prob_map_gen='2',
                             map_colour='43',
                             location_checks=dict(industry_min_distance=[('sawmill', 500), ('supply_yard', 500), ('stockyard', 2)], industry_max_distance=['stockyard', 10], same_type_distance=500),
