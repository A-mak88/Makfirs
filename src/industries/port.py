...
industry = IndustryPrimaryPort(id='port',
                               accept_cargo_types=['FOOD', 'PETR', 'GLAS', 'ELEC', 'MNSP', 'METL', 'MAIL', 'LVST'],
                               prod_cargo_types_with_multipliers=[('ENSP', 7), ('FMSP', 7), ('RFPR', 19)],
                               prob_in_game='5',
                               prob_map_gen='2',
                               map_colour='186',
...
#industry.economy_variations['IN_A_HOT_COUNTRY'].prod_cargo_types_with_multipliers = [('GOOD', 14), ('ENSP', 17)]
