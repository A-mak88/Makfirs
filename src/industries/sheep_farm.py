...
industry = IndustryPrimaryOrganic(id='sheep_farm',
                                  prod_cargo_types_with_multipliers=[('LVST', 4), ('WOOL', 14), ('PEAT', 4)],
                                  prob_in_game='10',
                                  prob_map_gen='10',
                                  map_colour='207',
                                  location_checks=dict(industry_max_distance=['arable_farm', 10], industry_min_distance=[('arable_farm', 2), ('orchard_piggery', 2)], same_type_distance=2),
