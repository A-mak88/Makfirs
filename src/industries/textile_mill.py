...
industry = IndustrySecondary(id='textile_mill',
                             accept_cargos_with_input_ratios=[('WOOL', 16), ('FICR', 6), ('WATR', 2), ('MNSP', 2), ('ELEC', 0), ('PASS', 0)], #
                             combined_cargos_boost_prod=True,
                             prod_cargo_types_with_output_ratios=[('TEXT', 8), ('PASS', 2)],
                             prob_in_game='3',
                             prob_map_gen='5',
                             map_colour='37',
                             location_checks=dict(industry_min_distance=[('lumber_yard', 2)], industry_max_distance=['lumber_yard', 5], same_type_distance=500),
