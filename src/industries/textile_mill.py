...
industry = IndustrySecondary(id='textile_mill',
                             accept_cargos_with_input_ratios=[('FICR', 6), ('WOOL', 6), ('ELEC', 1), ('RFPR', 2), ('MNSP', 2), ('PAPR', 1), ('PASS', 0)],
                             combined_cargos_boost_prod=True,
                             prod_cargo_types_with_output_ratios=[('GOOD', 8), ('MAIL', 2), ('PASS', 1)], #'TEXT' textiles?
                             prob_in_game='3',
                             prob_map_gen='5',
                             map_colour='37',
