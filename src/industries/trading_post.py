...
industry = Industrymaks(id='trading_post',
                               accept_cargos_with_input_ratios=[('FOOD', 4), ('PEAT', 4), ('WOOD', 1)],
                               combined_cargos_boost_prod=True,
                               prod_cargo_types_with_output_ratios=[('FMSP', 0), ('PASS', 0)],
                               prob_in_game='2',
                               prob_map_gen='6',
                               map_colour='37',
...
#industry.economy_variations['IN_A_HOT_COUNTRY'].prod_cargo_types_with_multipliers = [('ENSP', 7), ('FMSP', 6)]
